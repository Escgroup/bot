...
module.exports = class translate_command extends Command {
    ...
    async run(message, args) {
        ...
        const edit_message = await message.channel
            .send("<a:loading:482420749668188170> | Google翻訳をしています...");
        ...
        request.get({
            url: url,
            qs: {
                text: args.text, sl: "", tl: args.lang,
            },
        }, (error, response, body) => {

            if (error) return edit_message.edit(":x: | エラーが発生しました。");

            if (body.startsWith("<!DOCTYPE html>")) {
                edit_message.edit(":x: | 言語コードが違う可能性があります。(en,ja等)");
            } else {
                ...
                edit_message.edit({
                    embed: {
                        author: {
                            ...
                            icon_url: "https://img.icons8.com/color/48/000000/google-translate.png",
                        },
